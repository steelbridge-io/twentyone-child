<div class="card mb-4">
    <div class="card-body extra-padding">
        ...
        <p>FOR FAST SUPPORT RESPONSE: Please provide the URL or "Link" of where the issue described can be experienced. It helps us find your account if the domain in question is included in the subject. Please describe how we can duplicate the issue you are experiencing. Please describe the desired result. Screenshots help us understand what to expect.</p>
