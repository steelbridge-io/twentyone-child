<form method="post" action="{$smarty.server.PHP_SELF}?step=3" enctype="multipart/form-data" role="form">
    ...
    <div class="card">
        <div class="card-body extra-padding">
            ...
            <p>FOR FAST SUPPORT RESPONSE:<br>Please provide the URL or "Link" of where the issue described can be experienced. It helps us find your account if the domain in question is included in the subject. Please describe how we can duplicate the issue you are experiencing. Please describe the desired result. Screenshots help us understand what to expect.</p>

            <p>Expect an initial reply, even a solution same day if submitted before 3:00 PM PST. Support tickets
                and inquires submitted after 3:00 PM on Fridays will be responded to the following Monday by 12:00
                PM.</p>

            <p>For 24/7 emergency support: <a href="https://calendly.com/parsonshosting/emergency-support"
                                              title="emergency 24/7 support">Emergency Support</a></p>
